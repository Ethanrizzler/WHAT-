local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ethanrizzler/WHAT-/refs/heads/main/ethh.lua"))()
...
LeftGroupBox = Tabs.Main:AddLeftGroupbox('Aimlock')
    ...
    local previewColor = Color3.fromRGB(0, 0, 255) 
    local lockedHighlightColor = Color3.fromRGB(255, 0, 0) 
    local smoothness = 0 
    local highlightsEnabled = false 
    
    local ragelock = false  
...
Promo = {
    "Ethh.lol ON TOP!",
    "IM CLIPPING WITH THIS",
    "Ethh.lol Best Externel",
    "GET ETHH.lol fr",
    "ethh.lol to good fr"
}
    ...
    local function onKeyPress(input, gameProcessed)
        if not gameProcessed then
            if _G.autoStomp and input.KeyCode == stompKey then
                ...
                if isLooping then
                    showNotification("Auto Stomp Enabled", "Ethh.lol", 3)
                    startStomping()  -- Now calling startStomping properly
                else
                    showNotification("Auto Stomp Disabled", "Ethh.lol", 3)
                    stopStomping()
                end
            end
        end
    ...
    local function teleportAndStomp(targetPlayer)
        if targetPlayer and targetPlayer.Character then
            ...
            if targetHumanoid and torso and playerRoot then
                ...
                showNotification("Stomping", "Ethh.lol", 3)
            ...
            showNotification("No Target Found", "Ethh.lol", 3)
        end
    end
